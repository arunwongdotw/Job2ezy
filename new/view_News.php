...
{    
	$strSQL = "DELETE FROM tb_news ";
	$strSQL .="WHERE news_id = '".$_GET["news_id"]."' ";
...
<div class="container">
    <div class="single">  
	   <div class="form-container">
        <h2><a href="News_manag.php">เพิ่มข่าว  |</a> ดูข่าวทั้งหมด</h2>
...
?>
      <tr>
        <td><? echo $i;?></td>
        <td><?php echo $objResult["h1"];?></td>
        <td><?php echo $objResult["h3"];?></td>
        <td><?php echo $objResult["h2"];?></td>
