...
if($_REQUEST['action']=='insert'){
	...
	$sql1 = "SELECT * FROM member where m_username = '$username' and m_password = '$password'";
	...
	if($count1>0){
		...
		$result1['m_username'];
		$_SESSION['m_username']= $result1['m_username'];
...
<html>
<head>
<title>JOB2EZY | Login :: ผู้สมัครงาน</title>
                ...
                <div class="login-content">
					...
					<div class="login-btn" style="text-align: center;">
					   ...
					   <div class="login-bottom">
						...
						<h4>ลงทะเบียนเป็นสมาชิกงานกับ JOB2EZY.COM<a href="register.php"> ลงทะเบียนสมาชิกสมัครงาน</a></h4>
