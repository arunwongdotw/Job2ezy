...
if($_REQUEST['action']=='check'){
	...
	$sql1 = "SELECT * FROM business where b_username = '$b_username' and b_password = '$password1'";
	$query1 = mysql_query($sql1);
	$count1 = mysql_num_rows($query1);
	$result1 = mysql_fetch_array($query1);
	if($count1>0 and $password2==$password3){
		
		echo $sql2 = "update business set b_password = '$password2' where b_username = '$b_username'";
		mysql_query($sql2); 
		?><script>
		alert("แก้ไขรหัสผ่านเรียบร้อย");
		window.location="search_member.php";
        </script><?
		}else{ 
...
<html>
<head>
<title>JOB2EZY :: เปลี่ยนรหัสผ่าน</title>
    ...
    <div class="col-md-12 col-sm-6 col-lg-8 col-md-offset-2">
		<div class="jb-accordion-wrapper">
			...
			<div class="panel-body">								
					...
					<form action="repassword2.php?action=check" method="post">
