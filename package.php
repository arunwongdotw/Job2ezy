...
<strong><font  face="AngsanaUPC"><p style="font-size: 5em">แพ็กเกจ</p></font></strong>
           </div>
        </div>
   </div> 
</div> 
  		<div class="container">
  			...
  			<div class="clearfix"></div><br>
  				<div class="experience_content experience_content1">
  					<?while($result_package = mysql_fetch_array($query_package)){?>
  						<div class="col-md-4 new-more" ><div class="experience_1">

      						<div class="event">
      							</br><h2><?echo $result_package['package_name'];?></h2>
                				<h6><p style="font-size: 15px;color: blue">อัตราค่าใช้บริการ <?echo $result_package['package_price'];?> บาท *ไม่รวมภาษีมูลค่าเพิ่ม</p></h6>
              				</div>
                        ...
                        <?if($username == ''){?>
                            <input type="submit" name="submit" value="เข้าสู่ระบบก่อนซื้อ" class="btn btn-primary btn-sm" disabled></br></br>
                        <?}else{?>
            ...
            <div class="col-md-4 single_right" >
                  ...
                  <p style="color: #582584; font-size: 23px; font-weight: bold;">ธนาคารไทยพาณิชย์</p>
