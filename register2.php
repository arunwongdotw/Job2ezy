...
if($_REQUEST['action']=='insert'){
    ...
    if($count1<1 and $password1==$password2){
        ...
        $_SESSION['b_username']= $result3['b_username'];
        session_register("b_username");
        $_SESSION['m_username']="";
        ?><script>window.location="business.php";</script><?
        }else{ 
            ?><script>alert('username or password incorrect!!'); window.location="register2.php";</script><?
            }
    }
?>
...
<html>
<head>
<title>JOB2EZY | ลงทะเบียน :: ประกาศงาน</title>
...
<div class="container">
	   ...
	   <div class="form-container">
        ...
        <form action="register2.php?action=insert" method="post">
         ...
         <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-9">
                    <input type="password" inlength="6" maxlength="12" class="form-control input-sm" placeholder="Password 6-12 characters" name="password1" required>
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="login-btn" style="text-align: center;">
                       ...
                       <div class="login-bottom">
                        ...
                        <h4>เป็นสมาชิกอยู่แล้ว? <a href="login2.php">เข้าสู่ระบบ</a></h4>
    ...
    <!-- <p>เป็นสมาชิกอยู่แล้ว? <a href="login2.php">เข้าสู่ระบบ</a></p> -->
    </div>
 </div>
</div>
<? include "footer.php";?>
